...
import { FiMoreVertical, FiEdit2, FiDelete, FiDollarSign } from "react-icons/fi";
import {
  Button,
  Dialog,
  DialogActions,
...
export const CustomMoreVerticalActionsCampania = ({
  onDelete = () => console.log("delete"),
  onEdit = () => console.log("edit"),
  onActive = () => console.log("active"),
  onViewGasto = () => console.log("go gastos"),
  activeOnDelete = true,
  activeOnEdit = true,
  activeOnActive = true,
  activeOnGastos = true,
      ...
      >
        ...
        {activeOnGastos && (
          <MenuItem key={"gastos"} onClick={onViewGasto}>
            <FiDollarSign />
            <span className="ps-2">Ver gastos</span>
          </MenuItem>
        )
        }
      </Menu>
