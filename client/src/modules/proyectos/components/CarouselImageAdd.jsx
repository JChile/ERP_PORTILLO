...
import { deleteImagenProyecto } from "../helpers"
import {
  Dialog,
  DialogContent,
  DialogTitle,
...
const CarouselComponentImageAdd = ({ images, handleFileSelect, obtenerProyecto }) => {
  ...
  const handleDeleteConfirmation = async () => {
    try {
      await deleteImagenProyecto(selectedItemToDelete)
