# Generated by Django 4.2.2 on 2023-12-16 02:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.ForeignKey(default='A', null=True, on_delete=django.db.models.deletion.SET_NULL, to='cuenta.estadoregistro')),
                ('tipoProducto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ventas.tipocuota')),
            ],
        ),
        migrations.CreateModel(
            name='Objecion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombres', models.CharField(blank=True, max_length=100)),
                ('apellidoPaterno', models.CharField(blank=True, max_length=100)),
                ('nombreMaterno', models.CharField(blank=True, max_length=100)),
