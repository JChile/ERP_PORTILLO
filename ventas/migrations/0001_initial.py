# Generated by Django 4.2.2 on 2023-12-30 16:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asesor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuarioActualizador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarioActualizadorWhatsapp', to=settings.AUTH_USER_MODEL)),
                ('usuarioCreador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarioCreadorWhatsapp', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='TipoProducto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuarioActualizador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarioActualizadorProducto', to=settings.AUTH_USER_MODEL)),
                ('usuarioCreador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarioCreadorProducto', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Precio',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.ForeignKey(default='A', null=True, on_delete=django.db.models.deletion.SET_NULL, to='cuenta.estadoregistro')),
                ('lead', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='ventas.lead')),
                ('usuarioActualizador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarioActualizadorLlamada', to=settings.AUTH_USER_MODEL)),
                ('usuarioCreador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarioCreadorLlamada', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='lead',
        ...
        migrations.AddField(
            model_name='lead',
            name='usuarioActualizador',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarioActualizadorLead', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='lead',
            name='usuarioCreador',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarioCreadorLead', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='HistoricoLeadAsesor',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha_creacion', models.DateField(auto_now=True)),
                ('lead', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='ventas.lead')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuarioActualizador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarioActualizadorEvento', to=settings.AUTH_USER_MODEL)),
                ('usuarioCreador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarioCreadorEvento', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Cuota',
